...
- [project_eact_framework_assessment.md](project_eact_framework_assessment.md) — EAct framework assessment (2026-04-03): pane-app IS EAct, par is direct dependency (types used as phantom state), no MPST needed, BWindow dual-channel evidence
